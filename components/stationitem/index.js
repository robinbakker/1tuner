      ...
      return (
        <div class={'preset-list__item-content preset-list__item-content--station'}>
          {this.props.useLinksOnly ? (
            <Link
              href={stLink}
              title={this.props.stationItem.name}
              class={
                'preset-list__button' +
            ...
            <button
              data-station={this.props.stationItem.id}
              onClick={this.setStation}
              title={this.props.stationItem.name}
              class={
                'preset-list__button' +
                (this.props.small ? ' preset-list__button--small' : '') +
          ...
          {this.props.small ? null : (
            <div class={'preset-list__link-content'}>
              <Link href={stLink} class={'preset-list__link'}>
                {this.props.stationItem.name}
              </Link>
