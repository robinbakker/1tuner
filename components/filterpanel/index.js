  ...
  render() {
    if (this.props.languageList) {
      ...
      return (
        <div
          id="filtercontainer"
          onClick={this.toggleFilterPanel.bind(this)}
          class={style['filter-panel-container'] + ' ' + (this.props.showFilterPanel ? style['filter-panel-container--show'] : '')}
        >
            ...
            <div class={style['filter-panel-item']}>
              ...
              <div class={style['filter-panel-item__content']}>
                <ul id="langselection" class={style['lang-selection']}>
                  <li class={style['lang-selection__item']}>
                    <label>
                      <input
                        name={'lang-all'}
                        value={'all'}
                        type="checkbox"
                        onClick={this.clickAllLanguages.bind(this)}
                  ...
                  {this.props.languageList.map((langItem) => (
                    <li class={style['lang-selection__item']}>
                      <label>
                        <input
                          name={'lang-' + langItem.id}
                          value={langItem.id}
                          type="checkbox"
                          checked={langItem.active}
                          onClick={this.clickLanguage.bind(this)}
                        />
