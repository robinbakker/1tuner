  ...
  render() {
    ...
    return (
      <header class={style.header + ' app-header' + (this.props.inverted ? ' app-header--inverted' : '')}>
        <button class={style['header-btn'] + ' ' + style['header-btn--back']} title="Back" onClick={this.goBack.bind(this)}>
        ...
        {showShare ? (
          <button class={style['header-btn'] + ' ' + style['header-btn--share']} title="Share" onClick={this.shareUrl.bind(this)}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
