        ...
        <ul class={style['nav-list']}>
          <li class={style['nav-list__item']}>
            <Link title="Home" activeClassName={style.active} href="/" class={style['nav-link'] + ' ' + style['nav-link--home']}>
              <svg xmlns="http://www.w3.org/2000/svg" style="isolation:isolate" viewBox="0 0 42 42">
                <defs>
                  <clipPath id="cpHome">
          ...
          <li class={style['nav-list__item']}>
            <Link
              ...
              href="/radio-stations"
              class={style['nav-link'] + ' ' + style['nav-link--stations']}
            >
              <svg xmlns="http://www.w3.org/2000/svg" style="isolation:isolate" viewBox="0 0 42 42">
                <defs>
                  <clipPath id="cpRadio">
          ...
          <li class={style['nav-list__item']}>
            <Link title="Playlists" activeClassName={style.active} href="/playlists" class={style['nav-link'] + ' ' + style['nav-link--playlists']}>
              <svg xmlns="http://www.w3.org/2000/svg" style="isolation:isolate" viewBox="0 0 42 42">
                ...
                <g stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="3" stroke-width="2" clip-path="url(#a)">
          ...
          <li class={style['nav-list__item']}>
            <Link title="Settings" activeClassName={style.active} href="/settings" class={style['nav-link'] + ' ' + style['nav-link--settings']}>
              <svg xmlns="http://www.w3.org/2000/svg" style="isolation:isolate" viewBox="0 0 42 42">
                ...
                <g fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" clip-path="url(#a)">
